...
export default class Samurai extends GameEntity {
	static Defult_Attack = 45;
	...
	constructor(entityDefinition = {}) {
		...
		this.attack=Samurai.Defult_Attack;
		this.defense=Samurai.Defult_Defense;
		this.gold=Samurai.Defult_Gold;
