...
export default class Gard extends GameEntity {
	static Defult_Attack = 300;
	...
	constructor(entityDefinition = {}) {
		...
		this.attack=Gard.Defult_Attack;
		this.defense=Gard.Defult_Defense;
		this.gold=Gard.Defult_Gold;
