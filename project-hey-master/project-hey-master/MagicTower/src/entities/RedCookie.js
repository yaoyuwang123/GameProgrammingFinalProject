...
export default class RedCookie extends GameEntity {
	static Defult_Attack = 15;
	...
	constructor(entityDefinition = {}) {
		...
		this.attack=RedCookie.Defult_Attack;
		this.defense=RedCookie.Defult_Defense;
		this.gold=RedCookie.Defult_Gold;
