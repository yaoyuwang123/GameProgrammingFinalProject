...
export default class Sworder extends GameEntity {
	static Defult_Attack = 100;
	static Defult_Defense = 100;
	static Defult_Gold=100;
	
	constructor(entityDefinition = {}) {
		super(entityDefinition);
		this.dimensions = new Vector(GameEntity.WIDTH, GameEntity.HEIGHT);
		this.attack=Sworder.Defult_Attack;
		this.defense=Sworder.Defult_Defense;
		this.gold=Sworder.Defult_Gold;
